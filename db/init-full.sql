...
INSERT INTO articles (slug, title, excerpt, content, category, author, status, views, reading_time, tags, seo_title, seo_description, published_at) VALUES
...
'Советы', 'Финансовый эксперт', 'PUBLISHED', 1250, 5, ARRAY['микрозаймы', 'выбор МФО', 'финансы'],
'Как выбрать лучший микрозайм в 2025 году - полное руководство',
'Узнайте, как правильно выбрать МФО и не переплатить. Экспертные советы по выбору микрозайма с лучшими условиями.',
CURRENT_TIMESTAMP),
...
'Образование', 'Банковский консультант', 'PUBLISHED', 890, 4, ARRAY['грейс-период', 'кредитная карта', 'банки'],
'Грейс-период: что это и как правильно использовать',
'Что такое грейс-период на кредитной карте и как им пользоваться. Подробное объяснение с примерами расчёта.',
CURRENT_TIMESTAMP),
...
'Советы', 'Кредитный брокер', 'PUBLISHED', 2100, 6, ARRAY['кредитная история', 'кредитный рейтинг', 'советы'],
'Как улучшить кредитную историю - проверенные способы',
'Узнайте, как исправить кредитную историю и повысить свой кредитный рейтинг. Эффективные методы от экспертов.',
CURRENT_TIMESTAMP),
...
'Сравнение', 'Финансовый аналитик', 'PUBLISHED', 756, 5, ARRAY['кредитная карта', 'микрозайм', 'сравнение'],
'Кредитная карта или микрозайм: что выгоднее',
'Что лучше - кредитная карта или микрозайм? Сравнение условий, преимуществ и недостатков обоих вариантов.',
CURRENT_TIMESTAMP),
...
('Уралсиб Кэшбэк', 'Уралсиб Банк', 'У', 4.4, 4800, 5, 50, 1200, 300000, 13.0, 'Выгодный кэшбэк', ARRAY['Повышенный кэшбэк', 'Бесплатное обслуживание'], 'https://uralsib.ru/cards/credit/cashback/', 2100);
...
-- SELECT * FROM credit_cards ORDER BY rating DESC;
