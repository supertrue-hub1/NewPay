# KODA.md — Инструкция по проекту NewPay

## Обзор проекта

**NewPay** — это веб-приложение для сравнения микрофинансовых организаций (МФО) и займов в России. Сайт позволяет пользователям:
